...
<html>
    ...
    <body>
        <div id="navbar" class="w3-bar" style="background-color:#92C4BE">
            ...
            <a class="w3-bar-item w3-button" href="main?action=profile">Deets&trade;</a>
        ...
        <div class="w3-container">
            ...
            <!-- The post box looks odd here, visually. 
            I would prefer a button or link to the post instead -->
